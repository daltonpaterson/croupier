...
finale_neighbour_bets = middle.button("Finale Neighbour Bets", use_container_width=True)
full_completes = middle.button("Full Completes", use_container_width=True)
middle.divider()
